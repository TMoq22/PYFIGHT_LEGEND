...
def load_perso():
    perso = Personnage("Bob",10,10,[r"assets\Perso1.png",r"assets\Perso2.png",r"assets\Perso3.png",r"assets\Perso4.png"],screen,10,1,1,0,100,1,5)
    mobs = Personnage("mechant",10,10,[r"assets\Ennemi1.png",r"assets\Ennemi2.png",r"assets\Ennemi3.png",r"assets\Ennemi4.png"],screen,0,0,0,0,100,0,1)
    return perso,mobs
...
button = ImageButton(r"assets\bouton1.png", 15, 15, 60, 60)  
image_choix_touche = ImageButton(r"assets\exit.png", 240, 190, 60, 60)
quit_game = ImageButton(r"assets\exit.png", 240, 290, 60, 60)
affiche_coord = ImageButton(r"assets\exit.png", 240, 390, 60, 60)
button_show_quete1 = ImageButton(r"assets\bouton3.png", 340, 190, 60, 60)
button_show_quete2 = ImageButton(r"assets\bouton3.png", 340, 290, 60, 60)
button_fight = ImageButton(r"assets\bouton3.png", 240, 190,60, 60)
button_exit_quetes = ImageButton(r"assets\exit.png", 15, 15, 60, 60)
button_item_potion = ImageButton(r"assets\popo1.png", 240, 190, 60, 60)
button_item_livre = ImageButton(r"assets\book1.png", 240, 260, 60, 60)
button_item_potion2 = ImageButton(r"assets\popo2.png", 240, 330, 60, 60)
recommencer = ImageButton(r"assets\exit.png", 460, 360, 75,80)
quit_quetes = ImageButton(r"assets\exit.png", 460, 360, 75,80)
bouton_play = ImageButton(r"assets\button_play.png", 400, 490, 200,70)
boutton_egg = ImageButton(r"assets\on.png", 960, 10, 25, 25)
# boutons décoratifs
coin_img = ImageButton(r"assets\coin.png", 860, 533, 45,45)
xp_img = ImageButton(r"assets\exp.png", 860,475, 45,45)
vie_img = ImageButton(r"assets\hp.png", 265,538, 35,35)
speed_img = ImageButton(r"assets\speed.png", 860, 420, 45,45)
...
settingpng,settingpng_rect = load_img(r"assets\pancarte.png",(900,550),(500, 240))
menuquetes,menuquetes_rect = load_img(r"assets\pancarte.png",(900,550),(500, 240)) #(1100,700),(700, 300)
menushop,menushop_rect = load_img(r"assets\pancarte.png",(900,550),(500, 240))
game_over_img,game_over_img_rect = load_img(r"assets\game_over.jpg",(1000, 600))
winner_quete_img,winner_quete_img_rect = load_img(r"assets\winner_image.png",(1000, 600))
bienvenue_img,bienvenue_img_rect = load_img(r"assets\cadre.png",(1000, 600))


# |/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\| #

# definition les polices #
font=pygame.font.Font(r"assets\font_like_mc.ttf", 30)
font_titre = pygame.font.Font(r"assets\font_titre.ttf", 40)
font2 = pygame.font.Font(r"assets\font_pix_mc.ttf", 30)
fontdebug = pygame.font.Font(None, 30)
font_deco = pygame.font.Font(r"assets\font_videogames.ttf", 60)
font_bienvenue = pygame.font.Font(r"assets\Bake_Soda.otf", 30)
font_titre_jeux  = pygame.font.Font(r"assets\font_titre.ttf", 28)
font_fleche = pygame.font.Font(r"assets\PixArrows.ttf", 28)
font_zqsd = pygame.font.Font(r"assets\Gameplay.ttf", 20)
...
Quete1 = Quêtes(r"assets\fight.png",1,perso,mobs,r"assets\Perso1.png",r"assets\Ennemi3.png")
Quete2 = Quêtes(r"assets\fight.png",2,perso,mobs,r"assets\Perso1.png",r"assets\Ennemi3.png")
Boss_final = Quêtes(r"assets\fight.png",3,perso,mobs,r"assets\Perso1.png",r"assets\boss.png")

# |/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\| # 

# Chargement des sons du jeux #
pygame.mixer.init()
son_ambiance = pygame.mixer.Sound(r"assets\sfx_main_atmosphere.ogg")
son_ambiance.set_volume(0.2)
son_ambiance.play(loops =-1,maxtime =0,fade_ms =0 )

son_click = pygame.mixer.Sound(r"assets\sfx-pop.ogg")
son_click.set_volume(0.2)

son_cash = pygame.mixer.Sound(r"assets\sfx_cash.ogg")
son_cash.set_volume(0.2)

son_game_over = pygame.mixer.Sound(r"assets\sfx_game_over.ogg")
son_game_over.set_volume(0.8)
bruit_jouer = False

son_ambiance_quete = pygame.mixer.Sound(r"assets\Musique_test_quete.ogg")
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if boutton_egg.is_clicked(event) and boss_battu is True: # Changement du skin du joueur (uniquemet disponible après avoir vaincu le boss ) 
                if perso_skin_egg is False :
                    perso.update_sprites([r"assets\Perso5.png",r"assets\Perso6.png",r"assets\Perso7.png",r"assets\Perso8.png"])
                    Quete1.update_image_perso([r"assets\Perso5.png"])
                    Quete2.update_image_perso([r"assets\Perso5.png"])
                    Boss_final.update_image_perso([r"assets\Perso5.png"])
                    boutton_egg.update_img_button([r"assets\off.png"],25,25)
                    perso_skin_egg = True
                    
                elif perso_skin_egg is True :
                    perso.update_sprites([r"assets\Perso1.png",r"assets\Perso2.png",r"assets\Perso3.png",r"assets\Perso4.png"])
                    Quete1.update_image_perso([r"assets\Perso1.png"]) 
                    Quete2.update_image_perso([r"assets\Perso1.png"])
                    Boss_final.update_image_perso([r"assets\Perso1.png"])
                    boutton_egg.update_img_button([r"assets\on.png"],25,25)
                    perso_skin_egg = False
