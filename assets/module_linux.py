...
class Quêtes:
    def __init__(self, image,difficulte,personnage,mob,image_perso ,image_mob):
        ...
        self.button_fight = ImageButton("assets/force.png", 60, 20, 60, 60)
        self.button_potion = ImageButton("assets/popo1.png", 190, 20, 50, 50)
        self.button_livre = ImageButton("assets/book1.png", 300, 25, 50, 50)
        self.game_over_img = pygame.image.load("assets/game_over.jpg")
        ...
        # musique + bruitages 
        pygame.mixer.init()
        self.son_popo = pygame.mixer.Sound("assets/sfx_popo.ogg")
        self.son_popo.set_volume(0.8)
        self.son_book = pygame.mixer.Sound("assets/sfx_book.ogg")
        self.son_book.set_volume(0.9)
        self.son_swoosh = pygame.mixer.Sound("assets/sfx_swoosh.ogg")
