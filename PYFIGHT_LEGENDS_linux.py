...
from assets.module_linux import *
import textwrap
...
# /!\IL NECESSITE AUSSI LES FICHIERS ANNEXES ET NE DOIVENT                     #
# PAS ETRE CHANGER DE PLACE /!\                                                #
...
# /|PLAN DU CODE|\: (numéro de ligne + ou - éxacte)                            #
...
def load_perso():
    perso = Personnage("Bob",10,10,["assets/Perso1.png","assets/Perso2.png","assets/Perso3.png","assets/Perso4.png"],screen,10,1,1,0,100,1,5)
    mobs = Personnage("mechant",10,10,["assets/Ennemi1.png","assets/Ennemi2.png","assets/Ennemi3.png","assets/Ennemi4.png"],screen,0,0,0,0,100,0,1)
    return perso,mobs
perso,mobs = load_perso()

# |/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\| # 

# Variable pour le calcule des positions de cartains élements et tel que le lieu de spawn du perso principal  # 
fond_x = -100 
fond_y = -685 
...
button = ImageButton("assets/bouton1.png", 15, 15, 60, 60)  
image_choix_touche = ImageButton("assets/exit.png", 240, 190, 60, 60)
quit_game = ImageButton("assets/exit.png", 240, 290, 60, 60)
affiche_coord = ImageButton("assets/exit.png", 240, 390, 60, 60)
button_show_quete1 = ImageButton("assets/bouton3.png", 340, 190, 60, 60)
button_show_quete2 = ImageButton("assets/bouton3.png", 340, 290, 60, 60)
button_fight = ImageButton("assets/bouton3.png", 240, 190,60, 60)
button_exit_quetes = ImageButton("assets/exit.png", 15, 15, 60, 60)
button_item_potion = ImageButton("assets/popo1.png", 240, 190, 60, 60)
button_item_livre = ImageButton("assets/book1.png", 240, 260, 60, 60)
button_item_potion2 = ImageButton("assets/popo2.png", 240, 330, 60, 60)
recommencer = ImageButton("assets/exit.png", 460, 360, 75,80)
quit_quetes = ImageButton("assets/exit.png", 460, 360, 75,80)
bouton_play = ImageButton("assets/button_play.png", 400, 490, 200,70)
boutton_egg = ImageButton("assets/on.png", 960, 10, 25, 25)
# boutons décoratifs
coin_img = ImageButton("assets/coin.png", 860, 533, 45,45)
xp_img = ImageButton("assets/exp.png", 860,475, 45,45)
vie_img = ImageButton("assets/hp.png", 265,538, 35,35)
speed_img = ImageButton("assets/speed.png", 860, 420, 45,45)
...
settingpng,settingpng_rect = load_img("assets/pancarte.png",(900,550),(500, 240))
menuquetes,menuquetes_rect = load_img("assets/pancarte.png",(900,550),(500, 240)) #(1100,700),(700, 300)
menushop,menushop_rect = load_img("assets/pancarte.png",(900,550),(500, 240))
game_over_img,game_over_img_rect = load_img("assets/game_over.jpg",(1000, 600))
winner_quete_img,winner_quete_img_rect = load_img("assets/winner_image.png",(1000, 600))
bienvenue_img,bienvenue_img_rect = load_img("assets/cadre.png",(1000, 600))


# |/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\| #

# definition les polices #
font=pygame.font.Font("assets/font_like_mc.TTF", 30)
font_titre = pygame.font.Font("assets/font_titre.TTF", 40)
font2 = pygame.font.Font("assets/font_pix_mc.TTF", 30)
fontdebug = pygame.font.Font(None, 30)
font_deco = pygame.font.Font("assets/font_videogames.ttf", 60)
font_bienvenue = pygame.font.Font("assets/Bake_Soda.otf", 30)
font_titre_jeux  = pygame.font.Font("assets/font_titre.TTF", 28)
font_fleche = pygame.font.Font("assets/PixArrows.ttf", 28)
font_zqsd = pygame.font.Font("assets/Gameplay.ttf", 20)
...
Quete1 = Quêtes("assets/fight.png",1,perso,mobs,"assets/Perso1.png","assets/Ennemi3.png")
Quete2 = Quêtes("assets/fight.png",2,perso,mobs,"assets/Perso1.png","assets/Ennemi3.png")
Boss_final = Quêtes("assets/fight.png",3,perso,mobs,"assets/Perso1.png","assets/boss.png")

# |/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\||/\| # 

# Chargement des sons du jeux #
pygame.mixer.init()
son_ambiance = pygame.mixer.Sound("assets/sfx_main_atmosphere.ogg")
son_ambiance.set_volume(0.2)
son_ambiance.play(loops =-1,maxtime =0,fade_ms =0 )

son_click = pygame.mixer.Sound("assets/sfx-pop.ogg")
son_click.set_volume(0.2)

son_cash = pygame.mixer.Sound("assets/sfx_cash.ogg")
son_cash.set_volume(0.2)

son_game_over = pygame.mixer.Sound("assets/sfx_game_over.ogg")
son_game_over.set_volume(0.8)
bruit_jouer = False

son_ambiance_quete = pygame.mixer.Sound("assets/Musique_test_quete.ogg")
...
while loop:
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if boutton_egg.is_clicked(event) and boss_battu is True: # Changement du skin du joueur (uniquemet disponible après avoir vaincu le boss ) 
                if perso_skin_egg is False :
                    perso.update_sprites(["assets/Perso5.png","assets/Perso6.png","assets/Perso7.png","assets/Perso8.png"])
                    Quete1.update_image_perso(["assets/Perso5.png"])
                    Quete2.update_image_perso(["assets/Perso5.png"])
                    Boss_final.update_image_perso(["assets/Perso5.png"])
                    boutton_egg.update_img_button(["assets/off.png"],25,25)
                    perso_skin_egg = True
                    
                elif perso_skin_egg is True :
                    perso.update_sprites(["assets/Perso1.png","assets/Perso2.png","assets/Perso3.png","assets/Perso4.png"])
                    Quete1.update_image_perso(["assets/Perso1.png"]) 
                    Quete2.update_image_perso(["assets/Perso1.png"])
                    Boss_final.update_image_perso(["assets/Perso1.png"])
                    boutton_egg.update_img_button(["assets/on.png"],25,25)
                    perso_skin_egg = False
    ...
    if coord_debug == True and show_boss is False and show_quete2 is False and show_quete1 is False : # affichage des coordonnées "du joueu" ( c'est la map qui se deplace ) 
